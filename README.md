...
- 学生が新規登録を行いやすいように考えたデザイン。<br>

- 学生がPCからでもケータイからでも見られるようにレスポンシブデザイン化。<br>

- 人との繋がりを意識できるような機能。（DM機能、いいね機能、フォロー機能。）<br>

- イベントに需要があるか、学生がどんなイベントを求めているのかなど需要が認識しやすいようにいいね機能を実装した。<br>

- DM、フォロー、いいねされた際にノータイムで返信できるように通知機能を実装。（人との繋がりを促進する）<br>
...
- DMで画像を送信できるようにすることでLINEのQRコードなどから繋がりを継続させられるようにする。
- フォローした人のイベント投稿をすぐに確認できるようなページを作成する。
- イベント日時が過ぎたら投稿に終了しました。その後1日後に削除されるような実装。
- 見やすく、チャレンジしたくなるようなデザインにする。
- テストコードを書く。
