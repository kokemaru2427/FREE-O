...
使用例としましては以下を想定しています。
  ...
  ①遊びや趣味を行うためにメンバーを集う。<br>
    例【バスケットボールがしたいためメンバーを募集。】<br>
   ②新しい活動やプロジェクトを立ち上げたいためメンバーを集う。<br>
    例【パーティーイベントの運営チームを作りたいため初期スタッフを募集。】<br>
   ③新入生歓迎などサークルの活動に興味を持ってもらうために体験者を集う。<br>
    例【自分の所属するアカペラサークルの魅力を体験してもらいため新入生体験者を募集。】<br>

このアプリでは多くの人との出会いを大切にし、大学生のうちから集団での活動や運営の経験をする機会を作りたいと考えています。
...
- 自分が興味を持った投稿やユーザーにいいねやフォローが出来ます。
